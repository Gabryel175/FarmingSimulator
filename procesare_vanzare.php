...
if ($balanta >= $total) {
    ...
    $motiv = $product."-".$quantity."-"."ShopProduct";
    $total_minus=-$total;
    ...
    ?>
        <div class="bon-fiscal">
            ...
            <div class="body-bon-fiscal">
                <?php echo $data;  ?>
                <hr>
                <strong>Cumparator : </strong><?php echo $nume; ?>
                <strong>Produs : </strong><?php echo $product; ?>
                <strong>Cantitate : </strong><?php echo $quantity; ?>
                <hr>
                <strong>Pret total : </strong><?php echo $total;  ?>
            </div>
            <div class="footer-bon-fiscal"> 
                <strong>Farming Simulator Shop Product - Dovada platii , pastrati bonul </strong>
            </div>
        </div>
    <?php
} else {
